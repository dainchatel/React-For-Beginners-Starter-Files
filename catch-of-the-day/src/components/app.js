...
class App extends React.Component {
  ...
  addFish(fish) {
    //update our state
    //this.state.fishes.fish1 = fish; -- can do, but not best practice
    const fishes = {...this.state.fishes};
    //... is a "spread" -- will take every item from object and spread it into new object
    //add in our new fish
  ...
  render() {
    return (
      <div className="catch-of-the-day">
        <div className="menu">
          { /* can pass a boolean with brackets instead of quotes*/ }
